  ...
  return (
    <main className="container">
      <section className="card" style={{ marginBottom: 16 }}>
        ...
        <div className="small">
          Review discovered projects and taxonomy, then create a new project to generate a controls checklist.
        </div>
        <div className="hstack" style={{ marginTop: 12 }}>
          <a className="btn btnPrimary" href="/new">Create Project</a>
